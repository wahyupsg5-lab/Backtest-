...
# 23 coin: hapus SOLUSDT, SEIUSDT, TIAUSDT, HBARUSDT (WR rendah / PnL negatif),
#          BELUSDT (margin boros), VIRTUALUSDT, FARTCOINUSDT, IMXUSDT
COINS = [
    # Batch 1
    'XVGUSDT', '1000BONKUSDT', 'BERAUSDT', '1000PEPEUSDT',
    'ONDOUSDT', 'ENAUSDT', 'SHIB1000USDT',
    'JUPUSDT', 'OPUSDT',
    'ALGOUSDT', 'ORCAUSDT', 'XRPUSDT', 'XAUTUSDT', 'TAOUSDT',
    # Batch 2
    'SUIUSDT', 'AAVEUSDT', 'GALAUSDT',
    'GMXUSDT', 'SANDUSDT', 'AXSUSDT',
